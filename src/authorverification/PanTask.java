...
public class PanTask {
	...
	public static void main(String[] args) throws IOException{
		...
		if(!corpus.isDirectory()){
			System.out.println("First parameter is not a directory: "+corpus.getAbsolutePath()+". Expected: [input path] [output path]");
			//System.exit(0);
		}

		File outputdir = new File(args[1]);
		if(!outputdir.isDirectory()){
			System.out.println("Second parameter is not a directory: "+outputdir.getAbsolutePath()+". Expected: [input path] [output path]");
			//System.exit(0);
		}
